...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  List<Widget> _buildStackChildren(bool isLoading) {
    return [
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: _buildFormChildren(isLoading),
            ),
          ),
        ),
      ),
  ...
  List<Widget> _buildFormChildren(bool isLoading) {
    return [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(child: Stack(children: _buildStackChildren(isLoading))),
    );
  }
}
