...
class _MatchedItemsModalState extends ConsumerState<MatchedItemsModal>
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _AnimatedMatchCard(
                            ...
                            index: index,
                            onTap: () async {
                              showItemDetailsModal(context, match.item!.id);
                            },
                          );
                        },
                      ),
...
class _AnimatedMatchCardState extends State<_AnimatedMatchCard>
  ...
  void initState() {
    ...
    _scoreAnimation = Tween<double>(begin: 0.0, end: widget.match.score)
        .animate(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  // Removed per-item feedback buttons; card is clickable only
                ],
              ),
            ),
          ),
